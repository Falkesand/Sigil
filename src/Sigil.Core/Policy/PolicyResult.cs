...
public readonly record struct PolicyResult<T>
{
    private readonly T? _value;
    private readonly PolicyErrorKind? _errorKind;
    ...
    public PolicyErrorKind ErrorKind => !IsSuccess
        ? _errorKind!.Value
    ...
    private PolicyResult(T? value, PolicyErrorKind? errorKind, string? errorMessage, bool isSuccess)
    {
        _value = value;
    ...
    public static PolicyResult<T> Ok(T value) => new(value, null, null, true);

    public static PolicyResult<T> Fail(PolicyErrorKind errorKind, string errorMessage) =>
